import { anim2, anim4, author1, author10, author11, author12, author2, author9, static1, static2, static4 } from "@assets";
            ...
            <div className="d-item">
              <div className="nft__item">
                  ...
                  <div className="nft__item_wrap" style={{height: `${this.state.height}px`}}>
                    <Outer>
                      <span>
                          <img src={static1.src} className="lazy nft__item_preview" onLoad={this.onImgLoad} alt=""/>
                      </span>
                    </Outer>
                  </div>
              ...
              <div className="d-item">
                <div className="nft__item">
                    ...
                    <div className="nft__item_wrap" style={{height: `${this.state.height}px`}}>
                      <Outer>
                        <span>
                            <img src={static2.src} className="lazy nft__item_preview" onLoad={this.onImgLoad} alt=""/>
                        </span>
                      </Outer>
                    </div>
                    <div className="nft__item_info">
              ...
              <div className="d-item">
                <div className="nft__item">
                    ...
                    <div className="nft__item_wrap" style={{height: `${this.state.height}px`}}>
                      <Outer>
                        <span>
                            <img src={static4.src} className="lazy nft__item_preview" onLoad={this.onImgLoad} alt=""/>
                        </span>
                      </Outer>
                    </div>
                    <div className="nft__item_info">
            ...
            <div className="d-item">
                <div className="nft__item">
                    ...
                    <div className="nft__item_wrap" style={{height: `${this.state.height}px`}}>
                      <Outer>
                        <span>
                            <img src={anim4.src} className="lazy nft__item_preview" onLoad={this.onImgLoad} alt=""/>
                        </span>
                      </Outer>
                    </div>
                    <div className="nft__item_info">
            ...
            <div className="d-item">
                <div className="nft__item">
                    ...
                    <div className="nft__item_wrap" style={{height: `${this.state.height}px`}}>
                      <Outer>
                        <span>
                            <img src={anim2.src} className="lazy nft__item_preview" onLoad={this.onImgLoad} alt=""/>
                        </span>
                      </Outer>
                    </div>
                    <div className="nft__item_info">
