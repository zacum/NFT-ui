						...
						<div className='form-side'>
							<form className='formcontact' onSubmit={sendEmail}>
								...
								<input
									...
									required
								/>
								<textarea name='message' className='form-control bg-white' placeholder='Your Message' required />
								...
								<input type='submit' id='buttonsent' value='Submit Now' className='btn btn-main color-2 bg-white' />
							</form>
						</div>
					</div>
					...
					<div className='col-md-4'>
						<div className='padding40 box-rounded mb30'>
							...
							<address className='s1'>
								<span>
									<i className='id-color fa fa-map-marker fa-lg'></i>08 W 36th St, New York, NY 10001
								</span>
								<span>
						...
						<div className='padding40 box-rounded mb30 text-light'>
							...
							<address className='s1'>
								<span>
									<i className='fa fa-map-marker fa-lg'></i>100 Mainstreet Center, Sydney
								</span>
								<span>
